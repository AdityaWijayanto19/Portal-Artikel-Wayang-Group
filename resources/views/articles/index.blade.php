    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="p-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <form action="{{ route('articles.index') }}" method="GET" class="flex items-center gap-2 w-full sm:w-80">
                ...
                <table class="w-full text-left text-xs">
                    <thead class="bg-slate-50 border-b border-slate-200 text-slate-500 font-bold uppercase tracking-wider">
                        <tr>
                            ...
                            <th class="px-5 py-3 text-center">Skor SEO</th>
                            <th class="px-5 py-3">Publikasi Situs</th>
                                ...
                                <td class="px-5 py-3.5">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <span class="text-[10px] text-slate-400 font-mono truncate block">{{ $article->slug }}</span>
                                            <div class="flex flex-wrap gap-1 mt-1">
                                                @foreach ($article->categories as $category)
                                                    <span class="inline-flex px-1.5 py-0.5 rounded text-[9px] font-semibold bg-slate-100 text-slate-600">{{ $category->name }}</span>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-1">
                                        @forelse ($article->sitePublications as $pub)
                                            ...
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <span class="text-[11px] text-slate-600 truncate max-w-[140px]">{{ $pub->wpSite->site_name ?? 'Situs #' . $pub->wp_site_id }}</span>
